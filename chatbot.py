...
var2 = [ 'Jawad', 'Some_guy_whom_i_never_got_to_know.']
...
while True:
    ...
    if r.recognize_google(audio) in greetings:
       ...
       engine.say('I was made by Jawad')
       engine.runAndWait()
       ...
       mixer.init()
       mixer.music.load("J:\Jawad\MUSIC\[Drumstep] Teminite - Firepower.mp3")
       mixer.music.play()
    elif r.recognize_google(audio) in var4:
       engine.say('I am Athens your personal AI assistant')
       engine.runAndWait()
       ...
       owm = pyowm.OWM('a74b89896a44b51d2130771918fb60cc')
       observation = owm.weather_at_place('LAHORE, PAK')
       observation_list = owm.weather_around_coords(31.5204, 74.3587)
